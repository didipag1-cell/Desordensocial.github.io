...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    function showFaceFallback(progress = 0) {
        ...
        /*
           Seguridad visual:
           si el canvas falla, NO mostramos la fotografía
           original. Es preferible dejar la pieza vacía
           a enseñar la cara limpia en primer plano.
        */
    ...
    function drawSourceIntoCanvas(
        ...
        try {
            ...
            */
            ...
            console.warn(
                "No se pudo dibujar face.png en el canvas:",
                error
            );
    ...
    function drawDatamosh(
        ...
        /*
           En dispositivos táctiles actualizamos por pasos.
           En Apple reducimos todavía más la frecuencia para
           que Safari no se ahogue leyendo píxeles.
        */
        if (isTouchDevice) {
        ...
        */
        ...
        /*
           Misma estética, menos resolución interna en Apple.
           El canvas se sigue viendo al mismo tamaño por CSS:
           solo reducimos los píxeles que Safari procesa.
        */
        const internalScale =
            isAppleMobile
                ? (
        ...
        */
        ...
        /*
           Dibujar la fuente raster PNG.

           Si un navegador no puede hacerlo,
           no mostramos la fotografía original
